...
class AboutDialog(QtWidgets.QDialog):
    def __init__(self, parent: Optional[QtWidgets.QWidget] = None) -> None:
        ...
        btn_site = QtWidgets.QPushButton("Website")
        btn_site.setObjectName("AboutLink")
        btn_site.clicked.connect(lambda: QtGui.QDesktopServices.openUrl(QtCore.QUrl("https://dreamyphobic.github.io/AskDB/")))
